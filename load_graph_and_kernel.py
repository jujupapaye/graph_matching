...
def load_graph_and_kernels(subkernel_ind):
    """
    :param subkernel_ind: choice of which kernel we will be using to perform the matching
    0 using the full info: structure, coordinates, depth
    1 using coordinates, depth
    2 using structure, depth
    3 using structure, coordinates
    4 using structure
    5 using coordinates
    6 using depth
    :return: list of graph G_list with corresponding kernel K_list
    """
    # parameters
    hem = 'lh'
    graph_type = 'radius'
